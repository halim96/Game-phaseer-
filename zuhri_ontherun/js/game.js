  ...
  var SantaGame = {
    ...
    load: {
      preload: function() {
        ...
        this.game.load.audio('ho-ho-ho', 'assets/cobalagi-bos.mp3');
        this.game.load.audio('hop', 'assets/jump-sound.mp3');
        this.game.load.image('platform', 'assets/ground.png');
        this.game.load.spritesheet('santa-running', 'assets/zuhri.png', 37, 52);
        this.game.load.image('snow-bg', 'assets/snow-bg.png');
        this.game.load.image('snowflake', 'assets/snowflake.png');
        this.game.load.image("logo", "assets/logo-awal.png");
        this.game.load.image("instructions", "assets/instructions.png");
        this.game.load.image("game-over", "assets/selesai.png");
        this.game.load.image("startbtn", "assets/siap.png");
        this.game.load.image("playbtn", "assets/berangkat.png");
        this.game.load.image("restartBtn", "assets/mulai-lagi.png");
      },
      create: function() {
    ...
    play: {
      create: function() {
        ...
        if (highScore > 0) {
          this.highScore = this.game.add.text(20, 45, 'score paling luek: ' + highScore, {
            font: "18px Arial",
            fill: "black"
          });
        }
